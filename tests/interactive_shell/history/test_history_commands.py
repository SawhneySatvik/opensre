...
from interactive_shell.harness.llm_context import prompt_history as history_module
from interactive_shell.harness.llm_context.prompt_history.policy import RedactingFileHistory
...
def _redirect_history_path(monkeypatch: pytest.MonkeyPatch, target: Path) -> None:
    ...
    from interactive_shell.harness.llm_context.prompt_history import storage as history_storage
