...
Parsing the action plan is pure and lives in :mod:`agent.action_plan`. *Executing*
...
:class:`agent.ports.ActionDispatch` port.
...
from agent.action_plan import ALL_ACTION_CAPABILITIES, ActionPlanAction
