...
:func:`agent.gather.gather_tool_evidence`. This module is the terminal adapter:
...
to :func:`interactive_shell.harness.agent.answer_cli_agent`.
"""
...
from agent import gather as agent_gather
...
class _ShellGatherErrorReporter:
    """Minimal :class:`agent.ports.ErrorReporter` over ``report_exception``."""
...
def gather_tool_evidence(
    ...
    *,
    ...
    return agent_gather.gather_tool_evidence(
        message,
        session,
