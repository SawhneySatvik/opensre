...
Protocols in :mod:`agent.ports`. Nothing here imports ``interactive_shell``.
"""
...
from agent.action_plan import parse_action_plan
from agent.context import TurnContext
from agent.conversation_history import MAX_CONVERSATION_MESSAGES, format_recent_conversation
...
from agent.prompts import _build_observation_block, _build_system_prompt
