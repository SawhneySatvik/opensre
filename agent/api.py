...
:mod:`agent.headless`, but every dependency is injectable so a real surface can
override any of them.

Example::

    from agent.api import run_agent_turn
    from agent.headless import InMemorySessionStore, StaticReasoningClientProvider
...
from agent import driver, engine
from agent import gather as gather_mod
