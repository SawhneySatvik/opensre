...
from agent.conversation_history import (
    NO_HISTORY_PLACEHOLDER,
    format_recent_conversation,
)
from agent.ports import ErrorReporter, SessionStore, ToolEventObserver
    ...
    try:
        ...
        try:
            ...
            if error_reporter is not None:
                error_reporter.report(exc, context="agent.gather.client", expected=True)
            return None
        ...
        if error_reporter is not None:
            error_reporter.report(exc, context="agent.gather")
        return None
